# Programming Jokes Web Application
...
2. Know about creator by clicking on about creator button.A pop window showing information about
   creator will appear.

## Features that are used in this application.
